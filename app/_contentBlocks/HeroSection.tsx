...
const HeroSection = ({}: Props) => {
  ...
  return (
    <section className="relative md:bg-[url(https://images.unsplash.com/photo-1554995207-c18c203602cb?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] bg-cover bg-center bg-no-repeat w-full md:min-h-screen">
      <div className="hidden md:block absolute inset-0 bg-purple-800/25"></div>
      <div className="md:absolute z-10 right-10 top-1/4 flex flex-col md:bg-white/95 rounded-sm md:w-[630px] md:p-10 px-4 ">
        ...
        <Button className="mt-10 md:w-fit" size='lg' onClick={()=> router.push("/shop/all-products")}>Explore our products</Button>
      </div>
      <Image
